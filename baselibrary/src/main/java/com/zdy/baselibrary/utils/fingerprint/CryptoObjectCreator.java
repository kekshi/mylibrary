...
public class CryptoObjectCreator {
                ...
                try {
                    if (mCryptoObject != null) {
                        ...
                        if (!initCipher()) {
                            ...
                            Log.d("FGP","Failed to init Cipher.");
                        }
                    }
                } catch (Exception e) {
                    Log.d("FGP"," Failed to init Cipher, e:" + Log.getStackTraceString(e));
                }
    ...
    private void createKey() {
        ...
        try {
            ...
            Log.d("FGP"," Failed to createKey, e:" + Log.getStackTraceString(e));
    ...
    private boolean initCipher() {
        try {
            ...
            Log.d("FGP"," Failed to initCipher, e:" + Log.getStackTraceString(e));
            return false;
