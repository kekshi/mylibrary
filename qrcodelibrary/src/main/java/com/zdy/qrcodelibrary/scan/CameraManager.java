...
public final class CameraManager {
    ...
    public Camera open(final TextureView textureView, final int displayOrientation) throws IOException {
        ...
        try {
            ...
            if (savedParameters != null) {
                ...
                try {
                    ...
                    Log.i("canmera", "problem setting camera parameters" + x2.getMessage());
                }
            }
        }
        ...
        try {
            ...
            Log.i("canmera", "something went wrong while starting camera preview" + x.getMessage());
            camera.release();
            throw x;
        }
    }
    ...
    public void close() {
        if (camera != null) {
            try {
                ...
                Log.i("canmera", "something went wrong while stopping camera preview" + x.getMessage());
            }
    ...
    public void requestPreviewFrame(final PreviewCallback callback) {
        try {
            ...
            Log.i("canmera", "problem requesting preview frame, callback won't be called" + x.getMessage());
        }
    }
